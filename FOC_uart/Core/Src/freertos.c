...
/* Definitions for TaskNormal */
osThreadId_t TaskNormalHandle;
const osThreadAttr_t TaskNormal_attributes = {
  .name = "TaskNormal",
  .stack_size = 128 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of TaskNormal */
  TaskNormalHandle = osThreadNew(StartTaskNormal, NULL, &TaskNormal_attributes);
...
__weak void StartTaskNormal(void *argument)
{
